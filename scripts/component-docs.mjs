...
<div class="ns-banner ns-banner--success">
  ...
  },
  {
    ...
    a11y: [
      ...
      "The rail is a THREE-part grid — pinned head, scrolling middle, pinned foot — so the filter and the actions are on screen for the whole lesson. The track sits in the head as a header rather than a card: there is exactly one track, so a card promised a choice that does not exist, and it scrolled away by lesson three taking the answer with it",
      ...
      "A SKYSCRAPER SLOT (160&times;600, the standard unit from ads.css) runs down the leading edge of the body, sticky beside the reading. It begins BELOW the header, which owns the full width — a column starting at the top would push the title into two thirds of a page it should own outright. The article's own metadata is NOT there: author, date and reading time belong with the title in .ns-tmeta, the same way the lesson player states its lesson in its header. Facts about the page go in the page's header; a rail is for what is beside it",
