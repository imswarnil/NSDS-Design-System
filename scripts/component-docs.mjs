...
<div class="ns-banner ns-banner--success">
  ...
  },
  {
    ...
    a11y: [
      ...
      "One gutter for the whole rail: --ns-rail-pad is declared on the rail and used by the head, the list, the foot and the byline, so the search field, the section rows, the share buttons and the watermark all start and end on the same line. Four separate paddings had drifted to 12/16/8/12px, each defensible alone and visibly ragged together",
