The course catalog card — a mono index chip over the media, a status-dot level tag, mono price/meta readouts, and a hover state that's a 1px top accent line + border brighten (never a shadow lift).
